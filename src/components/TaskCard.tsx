...
const TaskCard = ({ task, deleteTask, updateTask }: Props) => {
    ...
    if(isDragging){
        return(
            ...
            rounded-xl cursor-grab relative
            "/>
        )
    }
        ...
        return (
            ...
            >
                <textarea
                    className="
                h-[90%]
                w-full resize-none border-none rounded
                ...
                -translate-y-1/2 bg-columnBackgroundColor p-2 rounded hover:opacity-100 opacity-60">
                    {<TrashIcons />}
                </button>}
            </div>
